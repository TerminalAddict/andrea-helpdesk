...
class ReplyService
{
    ...
    public function createAgentReply(int $ticketId, int $agentId, string $bodyHtml, bool $isPrivate = false, array $ccEmails = []): array
    {
        ...
        if (!$isPrivate) {
            ...
            if ($customer) {
                ...
                $notificationService->onAgentReply($ticket, $reply, $agent, $customer, $ccEmails);
            }
        }
